...
<div className="block lg:hidden fixed bottom-0 z-50 w-full -translate-x-1/2 bg-blue-600 rounded-t-2xl   border-t border-gray-200 left-1/2 dark:bg-gray-700 dark:border-gray-600">
